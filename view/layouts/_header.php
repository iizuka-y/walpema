...
<header>
    ...
    <nav>
        ...
        <ul>
            <li><a href="profile.php"><img src="../images/mypage.png" alt="マイページ"></a></li>
            <li><a href="notice.php"><img src="../images/news.png" alt="お知らせ"></a></li>
            <li><a href="wallpaper_list.php"><img src="../images/okiniiri.png" alt="お気に入り"></a></li>
            <li><a href="cart.php"><img src="../images/cart.png" alt="カート"></a></li>
        </ul>
        <?php else: ?>
        <ul>
            <li><a href="notice.php"><img src="../images/news.png" alt="お知らせ"></a></li>
